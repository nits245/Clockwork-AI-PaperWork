...
class DocumentEditor {
    ...
    `;
        ...
        const shortcuts = this.registry.getShortcutGroups().filter(group => ['Formatting', 'Alignment', 'Paragraph', 'Lists', 'Help'].includes(group.category));
